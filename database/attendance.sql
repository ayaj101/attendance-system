-- =============================================================
--  Attendance & Overtime Management System - Database Schema
--  Import this file in phpMyAdmin (XAMPP) or via the CLI:
--     mysql -u root < database/attendance.sql
--  Then run database/seed.php (or open install.php) to load demo data.
-- =============================================================
